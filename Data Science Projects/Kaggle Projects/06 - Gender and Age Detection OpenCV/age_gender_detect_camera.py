# -*- coding: utf-8 -*-
"""
Created on Mon Jun 19 13:58:54 2023
...
def initialize_cafe_models():
    ...
    age_net = cv2.dnn.readNetFromCaffe('files/deploy_age.prototxt',
                                       'files/age_net.caffemodel')
    
    gender_net = cv2.dnn.readNetFromCaffe('files/deploy_gender.prototxt',
                                       'files/gender_net.caffemodel')
